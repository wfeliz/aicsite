 ...
 */
function lac_theme(&$existing, $type, $theme, $path) {
  if (!db_is_active()) {
    return array();
  }
  include_once './' . drupal_get_path('theme', 'lac') . '/template.theme-registry.inc';
  return _lac_theme($existing, $type, $theme, $path);
}
/**
 ...
 */
function lac_breadcrumb($breadcrumb) {
 ...
 */
function lac_menu_item_link($link) {
 ...
 */
function lac_preprocess_page(&$vars, $hook) {
  ...
  if (!$vars['is_front']) {
    ...
    $classes[] = lac_id_safe('section-' . $section);
  }
 ...
 */
function lac_preprocess_node(&$vars, $hook) {
  ...
  $classes[] = lac_id_safe('node-type-' . $vars['type']);
 ...
 */
function lac_preprocess_comment(&$vars, $hook) {
 ...
 */
function lac_preprocess_block(&$vars, $hook) {
  $block = $vars['block'];
