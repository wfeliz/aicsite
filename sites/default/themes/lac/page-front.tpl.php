...
<head>
  ...
  <!--[if lte IE 7]> <style>.iehide{display:none;}div.search{text-align:right;width:300px;}</style><![endif]-->
  <?php print $head; ?>
  <?php print $styles; ?>
  <?php print $scripts; ?>
   <script type="text/javascript" src="/sites/default/themes/lac/column.js"></script>
    <script type="text/javascript" src="/sites/default/themes/lac/column2.js"></script>
...
<?php if ($navbar): ?>
  ...
  <div id="navbar-lac"><div id="navbar-inner" class="region region-navbar">
...
<script type="text/javascript">
try {
var pageTracker = _gat._getTracker("UA-11341938-3");
