 ...
 */
function cec_breadcrumb($breadcrumb) {
 ...
 */
function cec_menu_item_link($link) {
 ...
 */
function cec_preprocess_page(&$vars, $hook) {
  ...
  if (!$vars['is_front']) {
    ...
    $classes[] = cec_id_safe('section-' . $section);
  }
 ...
 */
function cec_preprocess_node(&$vars, $hook) {
  ...
  $classes[] = cec_id_safe('node-type-' . $vars['type']);
 ...
 */
function cec_preprocess_comment(&$vars, $hook) {
 ...
 */
function cec_preprocess_block(&$vars, $hook) {
  $block = $vars['block'];
