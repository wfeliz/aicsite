...
<head>
  ...
  <script type="text/javascript">$(function() {$('#content-top #block-views-cec_front_tabs-block_1 .block-inner .content .view-display-id-block_1 .view-content .item-list > ul').tabs({ fx: { opacity: 'toggle', duration: 'slow'} }).tabs('rotate', 10000);});</script>
   <script type="text/javascript" src="/sites/default/themes/cec/column.js"></script>
...
<script type="text/javascript">
var _gaq = _gaq || [];
_gaq.push(['_setAccount', 'UA-11341938-6']);
