 ...
 *   A form array.
 */
function ipc_settings($saved_settings, $subtheme_defaults = array()) {

  // Add the form's CSS
  drupal_add_css(drupal_get_path('theme', 'ipc') . '/theme-settings.css', 'theme');

  // Add javascript to show/hide optional settings
  drupal_add_js(drupal_get_path('theme', 'ipc') . '/theme-settings.js', 'theme');

  // Get the default values from the .info file.
  $defaults = ipc_theme_get_default_settings('ipc');
