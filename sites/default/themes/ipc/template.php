 ...
 */
function ipc_theme(&$existing, $type, $theme, $path) {
  if (!db_is_active()) {
    return array();
  }
  include_once './' . drupal_get_path('theme', 'ipc') . '/template.theme-registry.inc';
  return _ipc_theme($existing, $type, $theme, $path);
}
/**
 ...
 */
function ipc_breadcrumb($breadcrumb) {
 ...
 */
function ipc_menu_item_link($link) {
 ...
 */
function ipc_preprocess_page(&$vars, $hook) {
  ...
  if (!$vars['is_front']) {
    ...
    $classes[] = ipc_id_safe('section-' . $section);
  }
 ...
 */
function ipc_preprocess_node(&$vars, $hook) {
  ...
  $classes[] = ipc_id_safe('node-type-' . $vars['type']);
 ...
 */
function ipc_preprocess_comment(&$vars, $hook) {
 ...
 */
function ipc_preprocess_block(&$vars, $hook) {
  $block = $vars['block'];
