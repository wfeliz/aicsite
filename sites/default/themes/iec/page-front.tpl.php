...
<head>
  ...
  <script type="text/javascript" src="/sites/default/themes/aic/ui.tabs.ext.pack.js"></script>
   <script type="text/javascript">$(function() {$('#content-top #block-views-iec_front_tabs-block_1 .block-inner .content .view-display-id-block_1 .view-content .item-list > ul').tabs({ fx: { opacity: 'toggle', duration: 'slow'} }).tabs('rotate', 10000);});</script>
...
<?php endif; ?>
  <div id="page"><div id="page-inner">
    ...
    <div id="header" style="background:url(/sites/default/files/images/iec-banners/IEC-banner-<?php print (rand(1,2)) ?>.jpg) top left no-repeat;"><div id="header-inner" class="clear-block">
...
<?php if ($navbar): ?>
  ...
  <div id="navbar-iec"><div id="navbar-inner" class="region region-navbar">
...
<script type="text/javascript">
  ...
  var _gaq = _gaq || [];
  _gaq.push(['_setAccount', 'UA-11341938-4']);
