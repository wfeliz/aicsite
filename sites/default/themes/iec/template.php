 ...
 */
function iec_theme(&$existing, $type, $theme, $path) {
  if (!db_is_active()) {
    return array();
  }
  include_once './' . drupal_get_path('theme', 'iec') . '/template.theme-registry.inc';
  return _iec_theme($existing, $type, $theme, $path);
}
/**
 ...
 */
function iec_breadcrumb($breadcrumb) {
 ...
 */
function iec_menu_item_link($link) {
 ...
 */
function iec_preprocess_page(&$vars, $hook) {
  ...
  if (!$vars['is_front']) {
    ...
    $classes[] = iec_id_safe('section-' . $section);
  }
 ...
 */
function iec_preprocess_node(&$vars, $hook) {
  ...
  $classes[] = iec_id_safe('node-type-' . $vars['type']);
 ...
 */
function iec_preprocess_comment(&$vars, $hook) {
 ...
 */
function iec_preprocess_block(&$vars, $hook) {
  $block = $vars['block'];
