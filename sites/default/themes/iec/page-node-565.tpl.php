...
<head>
  ...
  <?php print $styles; ?>
  <?php print $scripts; ?>
  <script type="text/javascript" src="/sites/default/themes/iec/livevalidation.js"></script>
...
<script type="text/javascript">
		            var potential = new LiveValidation('potential');
		           potential.add(Validate.Presence);
</script>
<script type="text/javascript">
		            var individual = new LiveValidation('individual');
		           individual.add(Validate.Presence);
</script>
<script type="text/javascript">
...
<script type="text/javascript">
		           ...
		           gender.add(Validate.Exclusion, { within: ['Select'], failureMessage: "Please select an option!"});
</script>
</body>
</html>
