...
function setTall() {
	if (document.getElementById) {
		...
		var divs = new Array(document.getElementById('block-views-aic_front_buckets-block_1'), document.getElementById('block-views-aic_front_buckets-block_2'),document.getElementById('block-views-aic_front_buckets-block_3'));
